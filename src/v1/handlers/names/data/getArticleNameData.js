...
/**
 * collects all article names from the specified DB, which match the specified queries
 *
 * @access public
 *
 ...
 */
export default function getArticleNameData(queries: QueryParseResult, { client, index, type }: ElasticsearchConnection) {
